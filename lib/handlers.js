            ...
            if (!err && data) {
                ...
                if (hashedPassword == data.hashedPassword) {
                    ...
                    _data.create('tokens', tokenId, tokenObject, (err) => {
                        ...
                        _performance.measure('Passworrd hashing', 'beginning password hashing', 'password hashing complete');
                    ...
                    if (!err && data) {
                        ...
                        if (checks.length < config.maxChecks) {
                            ...
                            dns.resolve(hostName, (err, records) => {
                                ...
                                callback(400, { 'Error': 'Hostname did not resolve to any DNS entries' }, 'json');
                            });
                            return;
                        }
